...
public class LongestCSub {
    ...
    public static void main(String[] args) {
        ...
        hello.put("Ankur", "Bora");
        hello.put("Tan", "Rajkhowa");
        List<Map.Entry<String, String>> helloList = hello.entrySet().stream().filter(entry -> !entry.getValue().equalsIgnoreCase("Bora")).collect(Collectors.toList());
